...
function Constraint(underlying, constraint, correction, rightInverse) {
    return runtype_1.create(function (x) {
        ...
        return typed;
    }, { tag: 'constraint', underlying: underlying, constraint: constraint, correction: correction, rightInverse: rightInverse });
}
