...
export { type Parsed, default as Runtype, type Static } from "./Runtype.ts"
...
export { default as match, when } from "./utils/match.ts"
export type { default as Failure } from "./result/Failure.ts"
export type { default as Result } from "./result/Result.ts"
export type { default as Success } from "./result/Success.ts"